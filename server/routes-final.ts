...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen', 'Ubuntu', 'Cantarell', sans-serif; background: #f9fafb; }
  ...
  <script>
    (function() {
      ...
      function showAdminDashboard() {
        appDiv.innerHTML = '<div style="background:#f8fafc;min-height:100vh;font-family:system-ui,sans-serif">' +
      ...
      function showPatientDashboard() {
        appDiv.innerHTML = '<div style="background:#f0f2f5;min-height:100vh;font-family:system-ui,sans-serif">' +
